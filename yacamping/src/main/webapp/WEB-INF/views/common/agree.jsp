...
<body>
  <div class="wrap">
    <div class="container">
      ...
      <div class="agreetop">
        <div class="agreemenu">
          ...
          <a href="javascript:void(0)" class="menutitle"
            ...
            ></a>
          <div id="agree_content1" class="white_content"><div class="text1">제 1 조(목적) 이 약관은 '야캠핑어때' 주식회사(전자상거래 사업자)가 운영하는 '야캠핑어때' 사이버 몰(이
            ...
            <a href="javascript:void(0)"
              onclick="document.getElementById('agree_content1').style.display='none';document.getElementById('fade').style.display='none'"><div class="close">닫기</div></a>
          </div>
        ...
        <div class="agreemenu">
          ...
          <a href="javascript:void(0)" class="menutitle"
            ...
            ></a>
          <div id="agree_content2" class="white_content"><div class="text1">제 1 조 (목적) '야캠핑어때 주식회사'(이하 '야캠핑어때')은(는) 「개인정보 보호법」 제30조에 따라
            정보주체의
            개인정보를 보호하고 이와 관련한 고충을 신속하고 원활하게 처리할 수 있도록 하기 위하여 다음과 같이 개인정보 처리방침을 수립·공개합니다.<br>
            ○ 이 개인정보처리방침은 2022년 7월 25부터 적용됩니다.</div>
            <a href="javascript:void(0)"
              onclick="document.getElementById('agree_content2').style.display='none';document.getElementById('fade').style.display='none'"><div class="close">닫기</div></a>
          </div>
          <div id="fade" class="black_overlay"></div>
        </div>
        ...
        <div class="agreemenu">
          ...
          <a href="javascript:void(0)" class="menutitle"
            ...
            ></a>
          <div id="agree_content3" class="white_content"><div class="text1">제 1 조 (목적)
            본 약관은 회원(서비스 이용약관에 동의한 자를 말합니다. 이하 '회원'이라고 합니다.)이 야캠핑어때 주식회사(이하 '회사'라고 합니다.)가 제공하는 위치기반서비스(이하 '서비스'라고 합니다)를
            이용함에
            ...
            ②회원 및 법정대리인의 권리와 그 행사방법은 제소 당시의 이용자의 주소에 의하며, 주소가 없는 경우에는 거소를 관할하는 지방법원의 전속관할로 합니다. 다만, 제소 당시 이용자의 주소 또는 거소가
            ...
            ④회사는 개인위치정보주체의 동의 없이 개인위치정보를 제3자에게 제공하지 아니하며, 제3자에게 개인위치정보를 제공하는 경우에는 제공 받는자 및 제공목적을 사전에 개인위치정보주체에게 고지하고 동의를
            받습니다.

            ⑤회사는 개인위치정보를 회원이 지정하는 제3자에게 제공하는 경우에는 개인위치정보를 수집한 당해 통신 단말장치로 매회 회원에게 제공받는 자, 제공일시 및 제공목적을 즉시 통보합니다. 단, 아래 각
            호의
            ...
            <a href="javascript:void(0)"
              onclick="document.getElementById('agree_content3').style.display='none';document.getElementById('fade').style.display='none'"><div class="close">닫기</div></a>
          </div>
          <div id="fade" class="black_overlay"></div>
        </div>
        ...
        <div class="agreemenu">
          ...
          <a href="javascript:void(0)" class="menutitle"
            ...
            ></a>
          <div id="agree_content4" class="white_content"><div class="text1">제 1 조(목적) '야캠핑어때' 주식회사(이하 '야캠핑어때')에서 제공하는 이벤트/혜택 등 다양한 정보를
            휴대전화(알림
            또는 문자), 이메일로 받아 보실 수 있습니다. 일부 서비스(별도 회원 체계로 운영하거나 '야캠핑어때' 가입 이후 추가 가입하여 이용하는 서비스 등)의 경우, 개별 서비스에 대해 별도 수신
            동의를
            받을
            수 있으며, 이때에도 수신 동의에 대해 별도로 안내하고 동의를 받습니다.
            제 2 조(미동의시 불이익 사항)개인정보보호법 제22조 제 4항에 의해 선택정보 제공 사항에 대해서 동의 거부를 하더라도 서비스 이용에는 제한되지 않습니다. 다만, '야캠피어때'에서 제공되는
            할인,
            이벤트 및 다양한 서비스 상품 추천 등의 프로모션 정보 안내 서비스가 제한됩니다.</div>
            <a href="javascript:void(0)"
              onclick="document.getElementById('agree_content4').style.display='none';document.getElementById('fade').style.display='none'"><div class="close">닫기</div></a>
          </div>
          <div id="fade" class="black_overlay"></div>
        </div>
      </div>
      ...
      <div class="nextbtn">
        <button><a href="/register">동의하고 계속하기</a></button>
      </div>
